...
from AMS.models import Course,Session_Year, CustomeUser,Student,Staff,Subject,Staff_Notification,Class,Attendance
...
def ADD_CLASS(request):
    ...
    if request.method=="POST":
        ...
        new_class.save()
        messages.success(request,"Class Are SuccesssFully Added !!")
...
def UPDATE_CLASS(request):
    if request.method=="POST":
        ...
        # class_id=Class.objects.get(id=id_class)
        staff=Staff.objects.get(id=staff_id)
        session_year=Session_Year.objects.get(id=session_year_id)
        new_class=Class(
            id=id_class,
        ...
        new_class.save()
        messages.success(request, 'Class Are Successfully Added')
...
def DELETE_CLASS(request,id):
    new_class=Class.objects.get(id=id)
    new_class.delete()
    messages.success(request, 'Class Are Succesfully Deleted !!!')
    return redirect('view_class')
